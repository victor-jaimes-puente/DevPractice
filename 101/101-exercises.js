...
let onlyEvenNumbers = (s) => {
    let evens = [...s].filter(number => {
        return number % 2 == 0; 
    })
    return evens
}
...
let onlyPositiveNumbers = (s) => {
    let pos = [...s].filter(number => {
        return number >= 0; 
    })
    return pos
}
...
let onlyNegativeNumbers = (seq) => {
    let neg = [...seq].filter(number => {
        return number < 0; 
    }) 
...
let hasEvens = (seq) => {
    if (onlyEvenNumbers(seq).length > 0){
        return true
    } return false 
}
...
const countOdds = (seq) => {
    return onlyOddNumbers(seq).length
}
...
const countNegatives = (seq) => {
    return onlyNegativeNumbers(seq).length;
}
...
const countPositives = (seq) => {
    return onlyPositiveNumbers(seq).length;
}
